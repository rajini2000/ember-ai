 ...
 * Lines 39-44: EmberInferenceResult_t struct — AI-assisted
 * Lines 53-86: Function prototypes and documentation — ~30% AI-assisted
...
/* Forward declaration — full definition in ember_calibration.h */
struct CalibParams_tag;
typedef struct CalibParams_tag CalibParams_t;
...
/**
 * ember_inference_set_calib()
 * Pass calibration parameters from the SD card calibration routine.
 * When valid, raw sensor values are z-score normalized (val - mean) / std
 * before the standard NN normalization.
 */
